# Я считаю, что изобретать велосипед в виде валидации email
# контррационально, лучше или пользоваться готовыми библиотеками,
# или проверять существование домена, или просто отправлять
# письмо на адрес. Надеюсь, регулярки для валидации логина и
# пароля достаточно для демонстрации моих знаний. 
